...
const opt = {
  items: [
    ...
    },
    {
      ...
      description: 'Сертифицированный преподаватель по программе «Инструктор по йоге». регулярно посещаю семинары и продолжаю учиться. Ее направления - это Хатха-йога, Йога-терапия позвоночника, Йога-интенсив, Женская практика. Особое внимание Евгения  всегда уделяет правильному положению тела в позах для эффективной и безопасной практики. Для нее йога - это идеальное сочетание физической нагрузки, духовного развития и оздоровления всего организма в целом.'
    }
  ]
};
